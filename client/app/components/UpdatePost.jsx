...
const UpdatePost = ({postUpdate , handleEdit , content ,setContent}) => {
  return (
    <div className={`updated_menu ${postUpdate ? "flex" : "hidden"} postUpdate`}>
        <form action="" onSubmit={handleEdit} className={`flex z-[1000] items-start absolute top-[30%] right-[50%] left-[50%] translate-x-[-50%] flex-col gap-4 w-[500px] border-[1px] border-primary p-5 bg-[#181818] rounded-xl`}>
