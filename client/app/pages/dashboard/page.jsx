    ...
    return (
        <div className='dash w-[100%] min-h-[100vh] flex flex-col items-start pl-[14%] pt-8'>
            ...
            <div className='grid grid-cols-3 gap-4 my-4'>
                <Link href={`/pages/dashboard/pages/user`} className={`w-[400px] bg-[#0353a4] rounded-[10px] flex flex-col items-start gap-6 p-5`}>
                ...
                <Link href={`/pages/dashboard/pages/posts`} className={`w-[400px] bg-[#880d1e] rounded-[10px] flex flex-col items-start gap-6 p-5`}>
                    <div className='flex flex-row items-center justify-between w-full'>
                ...
                <Link href={`/pages/dashboard/pages/comments`} className={`w-[400px] bg-[#5a189a] rounded-[10px] flex flex-col items-start gap-6 p-5`}>
                    <div className='flex flex-row items-center justify-between w-full'>
